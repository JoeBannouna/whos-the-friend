...
//   check(() => room.players.length === 0);
//
//   let addPlayerOutput: StreamableRoomData | null = null;
//   for (const playerName of players)
//     addPlayerOutput = await RoomView.addPlayer(roomId, playerName, roomPass);
//
...
//   assertDefined(addPlayerOutput, 'addPlayerOutput');
//   verifyObject(addPlayerOutput, expectedBroadcastMessage);
//
...
//   const removePlayerResponse = await RoomView.removePlayer(
//     roomId,
//     room.players[removedPlayerIndex]!.id
//   );
...
//     const isLastCategory = k == jsonQuestions.categories.length - 1;
//
...
// };
//
// const tests: (() => Promise<boolean>)[] = [createRoomAndRunGame];
//
...
//# sourceMappingURL=socketManagerTest.js.map